...
dataErr2case1_DNN = load('test_Err2sin_case2_DNN.mat');
...
dataErr2case1_T = load('test_Err2sin_cases2_T.mat');
...
dataErr2case1_X = load('test_Err2sin_cases2_X.mat');
...
dataErr2case1_Both = load('test_Err2sin_cases2_XT.mat');
...
figure('name','error')
fig_mse2case1_DNN = plot(epoch,mse2case1_DNN,'r-*', 'linewidth',2);
hold on

bb = [0 0.55 0.8];
fig_mse2case1_T = plot(epoch, mse2case1_T,'-X', 'linewidth',2, 'color', bb);
hold on

fig_mse2case1_X = plot(epoch,mse2case1_X,'m:', 'linewidth',2);
hold on

fig_mse2case1_Both = plot(epoch,mse2case1_Both,'c-V', 'linewidth',2);
hold on

set(gca,'yscale','log')
set(gca, 'Fontsize', 18)
xlabel('epoch/1000', 'Fontsize', 18)
ylabel('MSE [g/L]', 'Fontsize', 18, 'Interpreter', 'latex')
xlim([0,51])
ylim([0.00001, 10])
hold on
% 
lgd0=legend([fig_mse2case1_DNN,fig_mse2case1_T],{'PINN','T-NPINN'},'orientation','horizontal','location','North');
set(lgd0,'FontSize',18.5);
lgd0.Position = [0.3  0.820  0.45  0.2];
legend boxoff;

ah1=axes('position',get(gca,'position'),'visible','off');
lgd1=legend(ah1,[fig_mse2case1_X,fig_mse2case1_Both],{'S-NPINN','ST-NPINN'},'orientation','horizontal','location','North');
